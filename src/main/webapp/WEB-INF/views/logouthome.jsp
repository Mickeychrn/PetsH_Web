...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="${pageContext.request.contextPath }/asset/images/1.jpg" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="${pageContext.request.contextPath }/asset/images/2.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
    ...
    <div class="carousel-item">
      <img src="${pageContext.request.contextPath }/asset/images/4.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
