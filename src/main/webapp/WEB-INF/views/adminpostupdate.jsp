							...
							<div class="card">
								<div class="card-body">
									...
									<div class="col-6">
										...
										<form
											action="/petsh/admin/post/update/${profileMap.forum.forumId}/update"
											method="post">

											<div class="form-group ">
												<label for="fullname">ID</label> <input type="text"
													class="form-control" name="updateId" id="example-disable"
													disabled="" value="${profileMap.forum.forumId}">
											</div>

											<div class="form-group ">
												<label for="fullname">Forum Title</label> <input
													value="${profileMap.forum.forumTitle}" class="form-control"
													type="text" name="forumTitle" required>
											</div>
											...
											<div class="form-group ">
												...
												<textarea class="form-control" name="forumContent" rows="3"
													required="required">${profileMap.forum.forumContent}</textarea>
											</div>
