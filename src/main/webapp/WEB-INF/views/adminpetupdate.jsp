						...
						<div class="col-12">
							<div class="card">
								...
								<div class="col-6">
									...
									<form
											action="/petsh/admin/pet/update/${profileMap.pet.petId}/update"
											method="post">

											<div class="form-group ">
												<label for="fullname">ID</label> <input type="text"
													class="form-control" name="updateId" id="example-disable"
													disabled="" value="${profileMap.pet.petId}">
											</div>

											<div class="form-group ">
												<label for="fullname">Pet Name</label> <input
													value="${profileMap.pet.petName}" class="form-control"
											...
											<div class="form-group ">
												<label for="fullname">Pet Color</label> <input
													value="${profileMap.pet.petColor}" class="form-control"
													type="text" name="petColor"
													required>
											</div>
											...
											<div class="form-group ">
												<label for="fullname">Pet Category</label> <input
													value="${profileMap.pet.petCategory}" class="form-control"
													type="text" name="petCategory"
													required>
											</div>
											
											<div class="form-group">
												<label for="password">Pet Description</label>
												<textarea class="form-control" id="example-textarea"
													rows="3" name="petDescription">${profileMap.pet.petDescription}</textarea>
											</div>

											<div class="form-group ">
												<label for="fullname">Pet Gender</label> <input
													value="${profileMap.pet.petGender}" class="form-control"
													type="text" name="petGender"
													required>
											</div>
